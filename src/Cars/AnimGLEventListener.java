...
class AnimGLEventListener extends AnimListener {
    ...
    String[] textureNames = {"mappp4.png", "Rcar.png", "car2.png", "Bcar.png", "Bcar.png"};
    ...
    double player1RoadLeft = maxWidth * 0.18;
    double player1RoadRight = maxWidth * 0.37;
    double player2RoadLeft = maxWidth * 0.63;
    double player2RoadRight = maxWidth * 0.84;
    double playerYMin = maxHeight * 0.1;
    ...
    public void keyPressed(KeyEvent e) {
        ...
        System.out.println("Player one cooedinates x: "+player1X +" "+"player1 coordinates y"+player1Y);
    ...
    public void keyReleased(KeyEvent e) {
        ...
        System.out.println("Player two cooedinates x: "+player2X +" "+"player2 coordinates y"+player2Y);
    }
