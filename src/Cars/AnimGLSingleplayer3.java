...
public class AnimGLSingleplayer3 extends AnimListener {
    ...
    private MediaPlayer collisionPlayer;
    boolean isPaused = false;



    double Leftbound = maxWidth * 0.3;
    double Rightbound = maxWidth * 0.7;
    double roadLeft = maxWidth * 0.3;
    double roadRight = maxWidth * 0.7;
    ...
    public void init(GLAutoDrawable glAutoDrawable) {
        ...
        new JFXPanel();
        soundPlayer.playBackgroundMusic("gmdei-tsz1y.wav");
        soundPlayer.preloadSound("العربيه اللي حيلتي باظت.wav");
    }
            ...
            if (!isGameOver && !isGameFinished) {
                ...
                if (checkCollision(playerX, playerY, enemy1X, enemy1Y) ||
                    ...
                    if (Lives > 0) {
                        ...
                        soundPlayer.playPreloadedSound();
    ...
    public class SoundPlayer {
        ...
        public void playBackgroundMusic(String resourcePath) {
            try {
                ...
                System.out.println("Background music playing: " + resourcePath);
            } catch (Exception e) {
                e.printStackTrace();
        ...
        public void preloadSound(String resourcePath) {
            try {
                new JFXPanel();
                URL soundURL = getClass().getResource(resourcePath);
                if (soundURL == null) {
                ...
                Media soundTrack = new Media(soundURL.toURI().toString());
                collisionPlayer = new MediaPlayer(soundTrack);
                System.out.println("Preloaded sound: " + resourcePath);
            } catch (Exception e) {
                e.printStackTrace();
                System.out.println("Error preloading sound: " + resourcePath);
            }
        }

        public void playPreloadedSound() {
            if (collisionPlayer != null) {
                collisionPlayer.stop();
                collisionPlayer.play();
                System.out.println("Playing preloaded collision sound.");
            } else {
                System.err.println("No collision sound preloaded.");
            }
        }
