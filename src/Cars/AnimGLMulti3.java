...
class AnimGLMulti3 extends AnimListener {
    ...
    String[] textureNames = {"road3multi.png", "Rcar.png", "car.png", "Bcar.png", "Pcar.png ", "player1.png","player2.png"};
    ...
    public void display(GLAutoDrawable glAutoDrawable) {
        ...
        if (gameOver) {
            ...
            if (winner == 1) {
                DrawSprite(gl, maxWidth / 2.0, maxHeight - 50, 5, 2.0f, 0);
            } else if (winner == 2) {
                DrawSprite(gl, maxWidth / 2.0, maxHeight - 50, 6, 2.0f, 0);
            }
